...
class СheckedException2 {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            /*
             * Блок "finally" используется в тех случаях, когда
             * условия данного блока должны быть выполнены во что бы то ни стало
             * В связи с этим, компилятор, обнаружив "finally",
             * предварительно выделяет память под его реализацию, 
