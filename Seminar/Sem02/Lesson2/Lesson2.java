...
наследует класс Throwable, который не наследует ничего, т.к.
...
Программные ошибки (Error), не обрабатываются, 
...
/**
 * CheckedException (проверенное исключение)
...
class CheckedException {
    public static void main(String[] args) {
        try {
             ...
             */
            FileReader fr = new FileReader("1.txt"); // Поток "FileReader" не закрыт 
                                                              // Способ закрытия (close) см. ниже
